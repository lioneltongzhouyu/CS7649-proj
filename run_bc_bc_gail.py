...
my_log_dir = os.path.join("output/bc_bc_gail/", env_name, seed)
...
print(f"[INFO] Reward after training BC: {reward_after_training}")
...
bc_trainer._policy = policy_trained_by_bc
...
# Visualization
# '''
# print("[INFO] Reward before training GAIL: ", np.mean(learner_rewards_before_training))
# print("[INFO] Reward after training GAIL: ", np.mean(learner_rewards_after_training))
